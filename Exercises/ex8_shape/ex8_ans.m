...
num %print on screen the number of objects
 ...
 my_total_bacteria_Area= sum(sum(bin_bact))
% 
for k=1:num
matlab_A(k)=area_obj(lab_bact,k);
end

matlab_A

matlab_total_bacteria_Area=sum(matlab_A)

A_vect=matlab_A %print the area values on the screen
...
F_rect %print the moments [m00, mu11, mu20, and mu02]
c_rect %print the centre [xc, yc]



%rotate the rectangle and compute everything as before
